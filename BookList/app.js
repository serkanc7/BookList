...
class Book {
  constructor(title, author, rating, isbn) {
    this.title = title;
    this.author = author;
    this.rating = rating;
    this.isbn = isbn;
...
bookForm.addEventListener("submit", (e) => {
  ...
  //Validate
  if (title === "" || author === "" || rating === "" || isbn === "") {
    UI.showAlert("Please fill in the required fields!", "danger");
  } else {
    //Instatiate book
    const book = new Book(title, author, rating, isbn);
